...
namespace model_ARMA_predict_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_ARMA_predict");
    ...
    reader.add_event(2932, 1, "restart", "model_ARMA_predict");
    reader.add_event(3018, 85, "end", "model_ARMA_predict");
    return reader;
}
...
class model_ARMA_predict
  : public stan::model::model_base_crtp<model_ARMA_predict> {
private:
        int n;
        int p;
        ...
        matrix_d P1;
public:
    model_ARMA_predict(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_ARMA_predict_namespace::model_ARMA_predict";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "steps_ahead", "int", context__.to_vec());
            steps_ahead = int(0);
            vals_i__ = context__.vals_i("steps_ahead");
            pos__ = 0;
            steps_ahead = vals_i__[pos__++];
            check_greater_or_equal(function__, "steps_ahead", steps_ahead, 1);
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_ARMA_predict_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            validate_non_negative_index("results", "p", p);
            validate_non_negative_index("results", "(p + 1)", (p + 1));
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> results(p, (p + 1));
            stan::math::initialize(results, DUMMY_VAR__);
            stan::math::fill(results, DUMMY_VAR__);
            // generated quantities statements
            current_statement_begin__ = 3013;
            stan::math::assign(results, predict(y, d, Z, H, c, T, R, Q, a1, P1, steps_ahead, pstream__));
            // validate, write generated quantities
            current_statement_begin__ = 3012;
            size_t results_j_2_max__ = (p + 1);
            size_t results_j_1_max__ = p;
            for (size_t j_2__ = 0; j_2__ < results_j_2_max__; ++j_2__) {
                for (size_t j_1__ = 0; j_1__ < results_j_1_max__; ++j_1__) {
                    vars__.push_back(results(j_1__, j_2__));
                }
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t j_2__ = 0; j_2__ < results_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < results_j_1_max__; ++j_1__) {
                ...
                param_name_stream__ << "results" << '.' << j_1__ + 1 << '.' << j_2__ + 1;
...
typedef model_ARMA_predict_namespace::model_ARMA_predict stan_model;
#ifndef USING_R
