...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(3182, 1, "restart", "model_SARIMA_model");
    reader.add_event(3352, 169, "end", "model_SARIMA_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            Q_ma = vals_i__[pos__++];
            check_greater_or_equal(function__, "Q_ma", Q_ma, 0);
            current_statement_begin__ = 3201;
            ...
            current_statement_begin__ = 3205;
            ...
            num_params_r__ += q_ma;
            current_statement_begin__ = 3240;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_gt(q_ma, 0))) {
                current_statement_begin__ = 3312;
            ...
            current_statement_begin__ = 3315;
            if (as_bool(logical_gt(Q_ma, 0))) {
