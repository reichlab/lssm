...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(3129, 1, "restart", "model_SARIMA_model");
    reader.add_event(3284, 154, "end", "model_SARIMA_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            num_params_r__ += q_ma;
            current_statement_begin__ = 3183;
            validate_non_negative_index("theta_seasonal", "Q_ma", Q_ma);
            num_params_r__ += Q_ma;
            current_statement_begin__ = 3186;
            num_params_r__ += 1;
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 3177;
        if (!(context__.contains_r("phi_seasonal")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable phi_seasonal missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("phi_seasonal");
        pos__ = 0U;
        validate_non_negative_index("phi_seasonal", "P_ar", P_ar);
        context__.validate_dims("parameter initialization", "phi_seasonal", "vector_d", context__.to_vec(P_ar));
        ...
        try {
            writer__.vector_unconstrain(phi_seasonal);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable phi_seasonal: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 3180;
        ...
        current_statement_begin__ = 3183;
        if (!(context__.contains_r("theta_seasonal")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable theta_seasonal missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("theta_seasonal");
        pos__ = 0U;
        validate_non_negative_index("theta_seasonal", "Q_ma", Q_ma);
        context__.validate_dims("parameter initialization", "theta_seasonal", "vector_d", context__.to_vec(Q_ma));
        ...
        try {
            writer__.vector_unconstrain(theta_seasonal);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable theta_seasonal: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 3186;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 3177;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> phi_seasonal;
            (void) phi_seasonal;  // dummy to suppress unused var warning
            if (jacobian__)
                phi_seasonal = in__.vector_constrain(P_ar, lp__);
            else
                phi_seasonal = in__.vector_constrain(P_ar);
            current_statement_begin__ = 3180;
            ...
            current_statement_begin__ = 3183;
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> theta_seasonal;
            (void) theta_seasonal;  // dummy to suppress unused var warning
            if (jacobian__)
                theta_seasonal = in__.vector_constrain(Q_ma, lp__);
            else
                theta_seasonal = in__.vector_constrain(Q_ma);
            current_statement_begin__ = 3186;
            ...
            current_statement_begin__ = 3204;
            validate_non_negative_index("R", "m", m);
            ...
            if (as_bool(logical_gt(p_ar, 0))) {
                current_statement_begin__ = 3217;
            ...
            current_statement_begin__ = 3241;
            if (as_bool(logical_gt(Q_ma, 0))) {
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> phi_seasonal = in__.vector_constrain(P_ar);
        size_t phi_seasonal_j_1_max__ = P_ar;
        for (size_t j_1__ = 0; j_1__ < phi_seasonal_j_1_max__; ++j_1__) {
        ...
        Eigen::Matrix<double, Eigen::Dynamic, 1> theta_seasonal = in__.vector_constrain(Q_ma);
        size_t theta_seasonal_j_1_max__ = Q_ma;
        for (size_t j_1__ = 0; j_1__ < theta_seasonal_j_1_max__; ++j_1__) {
