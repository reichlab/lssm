...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(3413, 1, "restart", "model_SARIMA_model");
    reader.add_event(3604, 190, "end", "model_SARIMA_model");
    return reader;
}
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            current_statement_begin__ = 3460;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (as_bool(logical_gt(P_ar, 0))) {
                current_statement_begin__ = 3539;
            ...
            // model body
            current_statement_begin__ = 3597;
            if (as_bool(logical_eq(horizon, 0))) {
                current_statement_begin__ = 3598;
